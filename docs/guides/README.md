...
| [`PROJECTS_BOARDS.md`](PROJECTS_BOARDS.md) | The ecosystem's GitHub Projects ticket boards. Catalog, provisioning from `scripts/projects_registry.json`, and day to day operations |
| [`REPORTS_TRIAGE_OPS.md`](REPORTS_TRIAGE_OPS.md) | How the AI report triage gets fired. The schedule gate, the manual trigger, and what to check when a run does not happen |
