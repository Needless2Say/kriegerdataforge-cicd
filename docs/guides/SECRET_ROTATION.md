...
Re-`paste` the previous value (repo/env secret), or for `VERCEL_DEPLOYMENT_TOKEN` re-run `generate`
...
### Manual override (enhanced security)

Nothing here blocks an out of cycle rotation. Run the
