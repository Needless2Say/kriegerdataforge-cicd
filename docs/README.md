...
- [`docs/agent/`](agent/) — `AGENT_OPERATING_STANDARD`, `DEFINITION_OF_DONE`, `DESIGN_AND_EPICS`, `DOCUMENTATION_STANDARD`, and `templates/` (ADR / design-spec / epic-tracker / contributor-onboarding).
