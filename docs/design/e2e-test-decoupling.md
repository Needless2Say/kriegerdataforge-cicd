...
An E2E journey is inherently *cross repo* (fitness needs fitness-fe + fitness-be + hub +
...
Cicd is touched **exactly twice** (engine in, fallback out), each tenant once, and **every future
