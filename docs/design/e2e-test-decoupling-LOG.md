...
0.5 → 1 → (2a/2b/2c in any order) → 3. Phase 1 keeps the E2E green with **zero** tenant
...
Cicd was touched exactly twice for tenant content. Engine IN (#112), transitional
